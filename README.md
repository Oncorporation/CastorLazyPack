...
**Download:** [CastorLazyPack1.4.91.zip](https://github.com/Oncorporation/CastorLazyPack/releases/download/CastorLazyPackv1.4.91/CastorLazyPack1.4.91.zip)
...
Completely new parameters, most of them are doable through api calls.
	...
	$text(<MESSAGE>,<STYLE>,<DURATION>) - displays <MESSAGE> (use + for spaces) in index.html for <DURATION> seconds with <STYLE> effect applied (fire,glitch,blue,matrix,normal,sunny,sparks,spin,spin3d,shine included as examples)
